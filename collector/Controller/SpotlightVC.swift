...
class SpotlightVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        spotlightCollectionView.isUserInteractionEnabled = true
        ...
        spotlightCollectionView.becomeFirstResponder()
...
extension SpotlightVC : UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    func collectionView(_ collectionView: UICollectionView, viewForSupplementaryElementOfKind kind: String, at indexPath: IndexPath) -> UICollectionReusableView {
        ...
        supplementaryView.button.applyGradientRounded(layoutIfNeeded: true, colors: [darkBlue.cgColor, lightBlue.cgColor])
